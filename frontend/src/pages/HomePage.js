      ...
      <div>
        ...
        <div className="lg:pl-20 ">
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b  px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 ">
              <form className="relative flex flex-1" action="#" method="GET">
                ...
                <input
                  id="search-field"
                  className="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-400 bg-transparent placeholder:text-gray-400 focus:ring-0 sm:text-sm"
                  placeholder="Search..."
                  type="search"
                  name="search"
                  autoComplete="off"
          ...
          <main className="xl:pl-96 ">
            <div style={{ height: 'calc(100vh - 120px)' }} className="px-4 py-10 sm:px-6 border-transparent m-5 border rounded-xl  relative scrollable-div overflow-auto bg-black border-none bg- lg:px-8 lg:py-6">
              <div className="px-4 py-10 sm:px-6 border-transparent border rounded-xl absolute h-full top-0 right-0 bottom-0 left-0 border-none  lg:px-8 lg:py-6">
                ...
                {/* Top 3 Games */}
                <GridList games={files1} listTitle={"Top Games"} width={"8/12"} aspectHeight={8} aspectWidth={5} mdCols='3' smCols='3' lgCols='3'></GridList> 
                <GridList games={files3} width={"full"} aspectHeight={5} aspectWidth={8} mdCols='5' smCols='5' lgCols='5'></GridList> 
                <HorizontalGameList listTitle={"Action"} games={files2}></HorizontalGameList>
                <HorizontalGameList listTitle={"Horror"} games={files2}></HorizontalGameList>
                <HorizontalGameList listTitle={"Indie"} games={files2}></HorizontalGameList>
                <HorizontalGameList listTitle={"FPS"} games={files2}></HorizontalGameList>
              </div>
            </div>
          </main>
        </div>
        ...
        <aside className="fixed bottom-0 left-20 top-16 hidden w-96  border-r border-gray-200  py-5 sm:px-6 lg:px-8 xl:block">
          ...
          <div style={{ height: 'calc(100vh - 120px)' }} className="px-4 py-10 sm:px-6 border-transparent  border rounded-xl  relative scrollable-div overflow-auto bg-black border-none bg- lg:px-8 lg:py-6">
            <div className="px-4 py-10 sm:px-6 border-transparent border rounded-xl absolute h-full top-0 right-0 bottom-0 left-0 border-none  lg:px-8 lg:py-6">
              ...
              <ul role="list" className="divide-y divide-gray-200">
                {files.map((file) => (
                  <li key={file.title} className="flex gap-x-4 py-5">
